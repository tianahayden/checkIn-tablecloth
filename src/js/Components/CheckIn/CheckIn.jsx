...
const Header = () => {
    return <div className='header'>
        <img src='logo.jpg' alt='traveling-stories-logo' />
    </div>
}
                ...
                return (
                    <div className='wrapper'>
                        ...
                        <div className='main'>
                            ...
                            <div>
                                <a className='button-orange' href={`https://storytentvisit.typeform.com/to/gu1NmX?clientid=${clientData.tableclothClientId}`} target='_blank'>Feeling Survey</a>
                            </div>
                            <div className='readingTests'>
                                <h3>Reading Tests</h3>
                                <a id='first' href={`https://storytentvisit.typeform.com/to/g4XfO7?clientid=${clientData.tableclothClientId}&gradelevel=Pre-K&word1=Where&word2=One&word3=See&word4=Play&word5=For`} target='_blank'>Pre K</a>
                                ...
                                <a id='last' href={`https://storytentvisit.typeform.com/to/g4XfO7?clientid=${clientData.tableclothClientId}&gradelevel=7th&word1=dinner&word2=spend&word3=match&word4=throughout&word5=chief`} target='_blank'>7th</a>
                            </div>
                            <div>
                                <a className='button-teal' href={`https://storytentvisit.typeform.com/to/rRzNmu?clientid=${clientData.tableclothClientId}`} target='_blank' onClick={this.checkInOut}>Check Out</a>
                            </div>
                        </div>
                    </div>
                )
